module.exports = (sequelize, DataTypes) => {
  const DailyCashBalance = sequelize.define("DailyCashBalance", {
    ...
    cash_fees_total: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
    expenses_total: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
    closing_balance: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
